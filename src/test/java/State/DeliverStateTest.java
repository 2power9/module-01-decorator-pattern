...
class DeliverStateTest {
    ...
    void nextStatusTest() throws InterruptedException {
        // GIVEN
        BeverageManager request = new BeverageManager();
        DeliverState status = new DeliverState(request);
    ...
    void notifyClientTest() throws InterruptedException {
        // GIVEN
        BeverageManager request = new BeverageManager();
        State status = new DeliverState(request);
        ...
        // THEN
        assertEquals("Order status: deliver", outputStreamCaptor.toString().trim());
    }
